...
// warranty section comp
const WarrantySection = () => {
  return (
    <section dir="rtl" className="bg-gray-100  py-16 px-4 sm:px-6 lg:px-12  ">
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          <div className="space-y-6 text-gray-800">
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              با ما خیالت از خرید راحت باشه. ضمانت‌ نامه وارانتی محصولات شاردر
              با اعتبار بالا و پوشش خدمات واقعی، آرامش خیال رو برای شما تضمین
              می‌کنه.
            </p>
          </div>
